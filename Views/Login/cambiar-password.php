...
<html lang="es">
    <head>
        ...
        <meta name="author" content="José miguel Peréa">
            ...
            <div class="login-box flipped">
                <form id="formCambiarPass" name="formCambiarPass" class="forget-form" action="">
                    ...
                    <div class="form-group">
                        <input id="txtPassword" name="txtPassword" autocomplete="new-password" class="form-control" type="password" placeholder="Nueva contraseña" required >
                    </div>
                    <div class="form-group">
                        <input id="txtPasswordConfirm" name="txtPasswordConfirm" autocomplete="new-password" class="form-control" type="password" placeholder="Confirmar contraseña" required >
                    </div>
